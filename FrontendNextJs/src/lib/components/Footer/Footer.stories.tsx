...
function makeSocialAccounts(links: { title: string; url: string }[]): any {
	return {
		content: {
			properties: {
				accounts: {
					items: links.map(({ title, url }) => ({
						content: {
							properties: {
								link: [{ title, url, target: '_blank', linkType: 'External' }]
							}
						}
					}))
				}
...
const mockSocialAccounts = makeSocialAccounts([
	{ title: 'Facebook', url: 'https://facebook.com/3chillies' },
	{ title: 'Instagram', url: 'https://instagram.com/3chillies' },
	{ title: 'X', url: 'https://x.com/3chillies' },
	{ title: 'LinkedIn', url: 'https://linkedin.com/company/3chillies' },
	{ title: 'GitHub', url: 'https://github.com/3chillies' }
]);
...
export const WithSocialLinks: Story = {
	args: {
		...
		socialMediaAccounts: makeSocialAccounts([
			...
			{ title: 'X', url: 'https://x.com/3chillies' },
			{ title: 'LinkedIn', url: 'https://linkedin.com/company/3chillies' },
			{ title: 'YouTube', url: 'https://youtube.com/@3chillies' },
			{ title: 'GitHub', url: 'https://github.com/3chillies' },
			{ title: 'Bluesky', url: 'https://bsky.app/profile/3chillies.bsky.social' }
		])
	}
};
